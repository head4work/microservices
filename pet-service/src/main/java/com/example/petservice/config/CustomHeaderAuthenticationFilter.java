...
public class CustomHeaderAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (userId != null && !userId.isEmpty() && rolesHeader != null) {
            ...
            System.out.println("PetService Filter: SecurityContext populated for user: " + userId + " with authorities: " + authorities); // Logging

        } else {
            System.out.println("PetService Filter: No/incomplete user headers found ("+ USER_ID_HEADER +", " + USER_ROLES_HEADER +"). Clearing SecurityContext."); // Logging
