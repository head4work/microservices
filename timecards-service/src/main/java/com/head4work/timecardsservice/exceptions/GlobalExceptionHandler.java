...
import com.head4work.timecardsservice.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TimeCardNotFoundException.class)
    public ResponseEntity<ErrorResponse> handleCompanyNotFoundException(TimeCardNotFoundException ex) {
